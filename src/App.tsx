...
function App() {
  ...
  // "Randomize all": transitions only — Ken Burns motion (effect) is left
  // untouched so a randomized transition plan never clobbers tuned motion.
