      ...
      <section className="project-heading">
        <div>
          <div className="eyebrow-line">
            <div className="eyebrow">PROJECT / UNTITLED</div>
            <div className="project-manage">
              <button className="btn ghost" title="Start a completely new blank project" onClick={requestNewProject}><Plus size={14}/> New project</button>
              <button className="btn ghost" title="Delete every saved project and temporary file" onClick={() => setShowClearAllConfirm(true)}><Trash2 size={14}/> Clear all</button>
            </div>
          </div>
