...
- Background jobs, live progress, downloadable output (real file sizes on every finished job, previews saved under the project's name, missing files flagged with a one-click re-render), persistent diagnostics, and render history
